...
import com.iscas.JavaExP.model.analyzeModel.ParameterSource;
import com.iscas.JavaExP.model.sootAnalysisModel.Context;
import com.iscas.JavaExP.model.sootAnalysisModel.Counter;
...
public class ValueObtainer {
	...
	private final Context contextsValue;
	private final String method_name;
	private final Map<Value, List<Value>> dependentMap;
...
//		log.info(depth+"  " +strVal.toString() +"  "+u.toString());
		if (depth >= 5)

...
public class RegularExpressionAnalyzer  extends Analyzer {
    ...
    public String addQeSymbolToMessage(String input) {
        String exceptionMsg = "";
        ...
        if (defOfLocal instanceof DefinitionStmt) {
            ...
            if (rightOp instanceof Constant) {
                ...
                if (invokeSig.equals("<java.lang.StringBuilder: java.lang.String toString()>") ||
                        invokeSig.equals("<java.lang.StringBuffer: java.lang.String toString()>")) {
                    ...
                    if (value instanceof Local) {
                        ...
                        || invokeSig.startsWith("<java.lang.StringBuffer: java.lang.StringBuffer append")) {
                ...
                }else if (invokeSig.startsWith("<java.lang.String: java.lang.String format(")) {
                    Value argConstant = invokeExpr.getArgs().get(0);
                    String s;
                    if (argConstant instanceof Constant) {
                        if (argConstant instanceof StringConstant) {

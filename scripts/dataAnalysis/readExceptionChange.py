    ...
    if "inter" in folder_name:
        ...
        if os.path.exists(json_file_path):
            with open(json_file_path, "r") as json_file:
                ...
                # 获取api_level的数据
                api_level_data = data.get("exception_level", {})
                ...
                exception_message_changed_amount = api_level_data.get("message_changed_exception_amount", 0)
                exception_type_changed_amount = api_level_data.get("type_changed_exception_amount", 0)
                exception_pre_conditions_changed_amount = api_level_data.get("pre_conditions_changed_exception_amount",
                                                                             0)
